...
Tower::Tower(QPoint pos, MainWindow *game, const QPixmap &sprite/* = QPixmap(":/image/tower.png"*/,int attackRange /*= 200*/,int damage /*= 10*/,int firerate /*= 1000*/)
	: m_attacking(false)
    , m_enemykilled(0)
...
void Tower::draw(QPainter *painter) const
{
    ...
    painter->drawPixmap(offsetPoint.x(),offsetPoint.y()-30,50,80, m_sprite);
    painter->drawText(-ms_fixedSize.width() / 2, -ms_fixedSize.height() / 2-30,QString("level : %1").arg(m_level));
	painter->restore();
}
...
void Tower::shootWeapon()
{
    ...
    else /*if(typeid(*this) == typeid(Tower1))*/
    {
...
bool Tower::containPoint(const QPoint &pos) const
{
