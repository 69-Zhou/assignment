...
enemyson1::enemyson1(int mapnum, MainWindow *game, const QPixmap &picture, int hp, int currenthp, int price, double movespeed):
...
void enemyson1::addwaypoint2(){
    WayPoint *wayPoint1 = new WayPoint(QPoint(1184,396));
    m_wayPointsList.push_back(wayPoint1);

    WayPoint *wayPoint2 = new WayPoint(QPoint(915,396));
    m_wayPointsList.push_back(wayPoint2);
    wayPoint2->setNextWayPoint(wayPoint1);

    WayPoint *wayPoint3 = new WayPoint(QPoint(915,139));
    m_wayPointsList.push_back(wayPoint3);
    wayPoint3->setNextWayPoint(wayPoint2);

    WayPoint *wayPoint4 = new WayPoint(QPoint(6,139));
    m_wayPointsList.push_back(wayPoint4);
    wayPoint4->setNextWayPoint(wayPoint3);
